        ...
        builder: (controller) {
          return
            Scaffold(
                ...
                controller.user.isEmpty ? const Center(
                      ...
                      children: [
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                const Text("Followers" , style: TextStyle(fontSize: 14 , fontWeight: FontWeight.w400))
                              ],
                            ),
                            ...
                            Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text(controller.user['following'] , style: const TextStyle(fontSize: 20 , fontWeight: FontWeight.w700),),
                                const SizedBox(height: 10,),
                                const Text("Followings" , style: TextStyle(fontSize: 14 , fontWeight: FontWeight.w400))
                              ],
                            ),
                            const SizedBox(width: 25,),
                            Column(
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Center(
                                child : Text( widget.uid == FirebaseAuth.instance.currentUser!.uid ?  "Sign Out" : controller.user['isFollowing'] ? "Following" : "Follow")
                            ),
                          ),
                        ),
                        const SizedBox(height: 20,),
